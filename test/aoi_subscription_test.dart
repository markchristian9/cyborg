...
void main() {
  group('구독 청크 격자', () {
    test('플레이어 청크는 사람 50 명에서 역산한 크기다', () {
      // 동접 1,000 명이 1,000 × 1,000 타일에 고르게 퍼졌을 때
      //   9 × C² × (1000 / 1000000) = 50  →  C ≈ 74.5
      const density = 1000 / (1000.0 * 1000.0);
      final expected = 9 * kPlayerSubChunkTiles * kPlayerSubChunkTiles * density;
      expect(expected, closeTo(50, 1.0));
    });
